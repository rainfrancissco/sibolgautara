            ...
            <div class="row">
                <div class="col-xl-6 col-md-6">
                    <div class="card card-shadow mb-4">
                        ...
                        <div class="card-body">
                            {!! Form::model($kelurahan, ['method'=>'PATCH', 'action'=>['KelurahanController@update', $kelurahan->id_kelurahan]]) !!}
                                <div class="form-group row">
                                    {!! Form::label('nama_kelurahan', "Nama Kelurahan", ['class' => 'col-sm-3 col-form-label']) !!}
                                    <div class="col-sm-9">
