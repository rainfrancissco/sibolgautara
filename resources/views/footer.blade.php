...
<!--init steps-->
<script src="{{ asset('assets/vendor/js-init/init-form-wizard.js') }}"></script>

<!--jquery stepy-->
<script src="{{ asset('assets/vendor/jquery-steps/jquery.stepy.js') }}"></script>
...
<script src="{{ asset('assets/vendor/js-init/chartjs/init-mixed-chart.js') }}"></script>
