...
<?php echo Form::hidden('id_kepalakeluarga', $IdWarga); ?>

<?php /* <?php echo Form::hidden('isactive', 'Y'); ?> */ ?>
...
<?php endif; ?>
	...
	<div class="col-sm-9">
		<?php echo Form::select('id_hubungan', array('1' => 'Suami',
        									  '2' => 'Istri',
        									  '3' => 'Anak',
        									  '4' => 'Saudara Lain'), null, ['class'=>'form-control form-control-sm rounded-0']); ?>
...
<?php else: ?>
	<div class="form-group row">
<?php endif; ?>
	<?php echo Form::label('id_berobat', 'Kebiasaan Berobat', ['class'=>'col-sm-3 col-form-label']); ?>
...
<?php else: ?>
	<div class="form-group row">
<?php endif; ?>
	<?php echo Form::label('id_bangunan', 'Bangunan', ['class'=>'col-sm-3 col-form-label']); ?>
