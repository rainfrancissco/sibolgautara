...
<head>
    ...
    <!--favicon icon-->
    <link rel="icon" type="image/png" href="<?php echo e(asset ('assets/img/favicon.html')); ?>">
    ...
    <link href="<?php echo e(asset ('assets/vendor/dashlab-icon/dashlab-icon.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset ('assets/vendor/simple-line-icons/css/simple-line-icons.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset ('assets/vendor/themify-icons/css/themify-icons.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset ('assets/vendor/weather-icons/css/weather-icons.min.css')); ?>" rel="stylesheet">

    <!--custom scrollbar-->
    <link href="<?php echo e(asset ('assets/vendor/m-custom-scrollbar/jquery.mCustomScrollbar.css')); ?>" rel="stylesheet">

    <!--jquery dropdown-->
    <link href="<?php echo e(asset ('assets/vendor/jquery-dropdown-master/jquery.dropdown.css')); ?>" rel="stylesheet">

    <!--jquery ui-->
    <link href="<?php echo e(asset ('assets/vendor/jquery-ui/jquery-ui.min.css')); ?>" rel="stylesheet">

    <!--iCheck-->
    <link href="<?php echo e(asset ('assets/vendor/icheck/skins/all.css')); ?>" rel="stylesheet">

    <!--vector maps -->
    <link href="<?php echo e(asset ('assets/vendor/vector-map/jquery-jvectormap-1.1.1.css')); ?>" rel="stylesheet" >
    ...
    <!--[if lt IE 9]>
    <script src="<?php echo e(asset ('assets/vendor/html5shiv.js')); ?>"></script>
    <script src="<?php echo e(asset ('assets/vendor/respond.min.js')); ?>"></script>
    <![endif]-->
...
<body class="fixed-nav top-nav">
    ...
    <nav class="navbar navbar-expand-lg fixed-top navbar-light" id="mainNav">
        <div class="box-container">
           ...
           <a class="navbar-brand navbar-brand-responsive" href="#">
               <img class="pr-3 float-left" src="assets/img/logo-icon.png" srcset="<?php echo e(asset ('assets/img/logo-icon@2x.png')); ?> 2x"  alt=""/>
    ...
    <script src="<?php echo e(asset ('assets/vendor/popper.min.js')); ?>"></script>
    <script src="<?php echo e(asset ('assets/vendor/bootstrap/js/bootstrap.min.js')); ?>"></script>
    <script src="<?php echo e(asset ('assets/vendor/jquery-dropdown-master/jquery.dropdown.js')); ?>"></script>
    <script src="<?php echo e(asset ('assets/vendor/m-custom-scrollbar/jquery.mCustomScrollbar.concat.min.js')); ?>"></script>
    <script src="<?php echo e(asset ('assets/vendor/icheck/skins/icheck.min.js')); ?>"></script>

    <!--chartjs-->
    <script src="<?php echo e(asset ('assets/vendor/chartjs/Chart.bundle.min.js')); ?>"></script>
    <!--chartjs initialization-->
    <script src="<?php echo e(asset ('assets/vendor/js-init/chartjs/init-creative-state-chart.js')); ?>"></script>
    <script src="<?php echo e(asset ('assets/vendor/js-init/chartjs/init-doughnut-chart.js')); ?> "></script>
    <script src="<?php echo e(asset ('assets/vendor/js-init/chartjs/init-doughnut-chart2.js')); ?>"></script>
    <script src="<?php echo e(asset ('assets/vendor/js-init/chartjs/init-sales-overview-chart.js')); ?>"></script>

    <!--vectormap-->
    <script src="<?php echo e(asset ('assets/vendor/vector-map/jquery-jvectormap-1.2.2.min.js')); ?>"></script>
    <script src="<?php echo e(asset ('assets/vendor/vector-map/jquery-jvectormap-us-aea.js')); ?>"></script>
    <!--vectormap initialization-->
    <script src="<?php echo e(asset ('assets/vendor/js-init/vmap/init-vmap-usa.js')); ?>"></script>
