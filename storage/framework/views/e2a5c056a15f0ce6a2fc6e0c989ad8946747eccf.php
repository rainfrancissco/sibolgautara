            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    ...
                    <div class="creative-state-info text-center pull-left">
                        <h3 class="mt-4"><?php echo e($TotalDataWarga); ?> </h3>
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    ...
                    <div class="creative-state-info text-center pull-left">
                        ...
                        <h3 class="mt-4"><?php echo e($Max->jumlah); ?></h3>
                        <p class="mb-0"><?php echo e($Max->kelurahan); ?></p>
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    ...
                    <div class="creative-state-info text-center pull-left">
                        ...
                        <h3 class="mt-4"><?php echo e($Min->jumlah); ?></h3>
                        <p class="mb-0"><?php echo e($Min->kelurahan); ?></p>
