                        ...
                        <?php if(count($kepalakeluarga_list)>0): ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php echo e(link_to('user/' . $kepalakeluarga->id_warga . '/view', 'View', ['class' => 'btn btn-success btn-sm form-pill'])); ?>

                                    <?php echo e(link_to('warga/' . $kepalakeluarga->id_warga . '/editkk', 'Edit', ['class' => 'btn btn-warning btn-sm form-pill'])); ?>

                                    <?php echo e(link_to('user/' . $kepalakeluarga->id_warga . '/hapus', 'Hapus', ['class' => 'btn btn-danger btn-sm form-pill'])); ?>
